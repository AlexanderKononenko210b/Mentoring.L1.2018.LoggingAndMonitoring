...
namespace MvcMusicStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(ILoggerService logger, CounterHelper<Counters> counterHelper)
            : this(new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new ApplicationDbContext())), logger, counterHelper)
        {
        }
        ...
        {
            _logger.Trace("Login method started");
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    _counterHelper.Increment(Counters.LogIn);
            ...
            _logger.Trace("Login method finished");
        ...
        public ActionResult LogOff()
        {
            ...
            _logger.Info("LogOff method work.");
            _counterHelper.Increment(Counters.LogOff);
            return RedirectToAction("Index", "Home");
        }
